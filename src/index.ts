...
const OUTPUT_PATH = "./data/parm_sold.json"
...
const getPropertyCards = async () => {
    ...
    const promises = pageArray.map((page) => {
        return fetch("https://gateway.homes.co.nz/map/cards", {
            ...
            "body": "{"+parm_sold+",\"page\":" + page + ",\"limit\":1000,\"display_rentals\":false,\"for_rent\":false,\"for_sale\":false,\"just_sold\":true,\"off_market\":false}",
            "method": "POST"
        }).then(res => res.json());
    })
